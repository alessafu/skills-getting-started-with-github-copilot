...
activities = {
    ...
    "Basketball Team": {
        "description": "Practice basketball skills and play in inter-school competitions",
    ...
    "Math Olympiad": {
        "description": "Prepare for math competitions and tackle challenging problem sets",
